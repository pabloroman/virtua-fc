...
class GameMatch extends Model
{
    ...
    /**
     * True when extra time was simulated for this match. Derived from
     * the presence of an ET score — replaces the redundant `is_extra_time`
     * column that PR 1 deprecated. Phase-aware callers can also check
     * for any event with `phase` in the ET group.
     */
