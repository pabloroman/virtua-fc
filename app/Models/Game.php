...
class Game extends Model
{
    ...
    /**
     * Advance current_date to the next unplayed match (forward-looking).
     *
     * This is the single canonical way to advance the game calendar.
     * Only moves forward — never regresses the date.
     *
