    ...
    public function pitchSlots(): array
    {
        return match ($this) {
            ...
            self::F_4_2_3_1 => [
                ...
                ['id' => 7, 'role' => 'Midfielder', 'col' => 1, 'row' => 8, 'label' => 'LM'],
                ['id' => 8, 'role' => 'Midfielder', 'col' => 4, 'row' => 8, 'label' => 'AM'],
            ...
            self::F_3_4_3 => [
                ...
                ['id' => 4, 'role' => 'Midfielder', 'col' => 3, 'row' => 5, 'label' => 'DM'],
                ['id' => 5, 'role' => 'Midfielder', 'col' => 5, 'row' => 5, 'label' => 'DM'],
                ['id' => 6, 'role' => 'Midfielder', 'col' => 2, 'row' => 8, 'label' => 'CM'],
                ['id' => 7, 'role' => 'Midfielder', 'col' => 6, 'row' => 8, 'label' => 'CM'],
                ['id' => 8, 'role' => 'Forward', 'col' => 1, 'row' => 10, 'label' => 'LW'],
                ['id' => 9, 'role' => 'Forward', 'col' => 4, 'row' => 11, 'label' => 'CF'],
                ['id' => 10, 'role' => 'Forward', 'col' => 7, 'row' => 10, 'label' => 'RW'],
            ],
            self::F_3_5_2 => [
                ...
                ['id' => 2, 'role' => 'Defender', 'col' => 4, 'row' => 3, 'label' => 'CB'],
                ['id' => 3, 'role' => 'Defender', 'col' => 6, 'row' => 3, 'label' => 'CB'],
                ['id' => 4, 'role' => 'Midfielder', 'col' => 1, 'row' => 6, 'label' => 'LWB'],
                ['id' => 5, 'role' => 'Midfielder', 'col' => 3, 'row' => 6, 'label' => 'CM'],
                ['id' => 6, 'role' => 'Midfielder', 'col' => 5, 'row' => 6, 'label' => 'CM'],
                ['id' => 7, 'role' => 'Midfielder', 'col' => 7, 'row' => 6, 'label' => 'RWB'],
                ['id' => 8, 'role' => 'Midfielder', 'col' => 4, 'row' => 8, 'label' => 'AM'],
                ['id' => 9, 'role' => 'Forward', 'col' => 3, 'row' => 11, 'label' => 'CF'],
                ['id' => 10, 'role' => 'Forward', 'col' => 5, 'row' => 11, 'label' => 'CF'],
            ],
            ...
            self::F_5_3_2 => [
                ...
                ['id' => 9, 'role' => 'Forward', 'col' => 3, 'row' => 10, 'label' => 'CF'],
                ['id' => 10, 'role' => 'Forward', 'col' => 5, 'row' => 10, 'label' => 'CF'],
            ],
            self::F_5_4_1 => [
                ['id' => 0, 'role' => 'Goalkeeper', 'col' => 4, 'row' => 0, 'label' => 'GK'],
