...
return [
    ...
    'atmosphere_shot_on_target' => [
        'Shot by :player! The keeper holds on',
        ':player tries from distance. Good save',
        'Effort from :player forces the goalkeeper into action',
        ':team had a chance! :player\'s shot is saved by the keeper',
        ':player fires at goal, but the keeper was well positioned',
        'What a strike from :player! Great save from the goalkeeper',
    ],
    'atmosphere_shot_off_target' => [
        'Close! :player\'s shot drifts just wide (:team)',
        ':player lets fly but it goes over the bar',
        ':player shoots from range... just off target',
        'Effort from :player sails wide of the post',
        ':player tries to pick out the corner but can\'t find the target',
        'Nearly! :player comes close but the ball goes wide',
    ],
    'atmosphere_foul' => [
        'Foul by :player, the referee has no hesitation',
        ':player brings down a :opponent player on the break',
        ':player goes in late and gives away a free kick',
        ':player clips the heels of the attacker, free kick',
        'The referee blows for a foul by :player',
        ':player fouls in attack, turnover',
    ],
    'atmosphere_substitution' => [
        'Substitution for :team, :player_in comes on for :player_out',
        'Change for :team: :player_out makes way for :player_in',
        ':player_out is replaced by :player_in for :team',
        ':team make a change: :player_in on for :player_out',
    ],
    'atmosphere_injury' => [
        'Play is stopped due to an injury to :player',
        ':player is down and needs medical attention',
        'Bad news for :team, :player appears to be injured',
        'The game is halted, :player cannot continue',
    ],
