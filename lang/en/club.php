...
return [
    ...
    'stadium' => [
        ...
        'upgrades' => [
            ...
            'modal_rebuild_description' => 'Knock down the existing ground and build a new one. Per-seat cost rises in brackets: the bigger the stadium, the more each additional seat costs.',
            'rebuild_disruption_warning' => 'Construction runs ~18 months. The stadium stays open during the build; the new capacity goes live on the completion date.',
