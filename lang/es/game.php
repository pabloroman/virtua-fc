...
return [
    ...
    'atmosphere_shot_on_target' => [
        '¡Disparo de :player! El portero atrapa sin problemas',
        ':player lo intenta desde fuera del área. Buena parada',
        'Remate de :player que obliga a intervenir al guardameta',
        '¡La tuvo :team! Disparo de :player que rechaza el portero',
        ':player remata a puerta, pero el portero estaba bien colocado',
        '¡Ojo al disparo de :player! Tremenda parada del portero',
    ],
    'atmosphere_shot_off_target' => [
        '¡Uyyy! Tiro fuera de :player (:team)',
        ':player lo intenta pero el balón se marcha desviado',
        'Remate alto de :player, se le fue por encima del larguero',
        ':player dispara desde la frontal... se marcha por poco',
        'Lo intenta :player desde lejos, pero no encuentra portería',
        '¡Casi! :player se queda cerca pero el balón se va fuera',
    ],
    'atmosphere_foul' => [
        'Falta de :player, el árbitro no duda en señalar',
        ':player corta en falta una jugada prometedora de :opponent',
        'Derribo de :player en el centro del campo',
        ':player llega tarde a la disputa y comete falta',
        'El árbitro señala falta de :player tras un forcejeo',
        'Falta de :player en ataque, cambio de posesión',
    ],
    'atmosphere_substitution' => [
        'Cambio en :team, entra al campo :player_in sustituyendo a :player_out',
        'Cambio en :team: se retira :player_out y entra :player_in',
        ':player_out deja su lugar a :player_in en :team',
        'Movimiento en :team: :player_in entra por :player_out',
    ],
    'atmosphere_injury' => [
        'El juego está detenido debido a la lesión de :player',
        ':player se queda en el suelo, necesita asistencia médica',
        'Malas noticias para :team, :player parece lesionado',
        'Se detiene el partido, :player no puede continuar',
    ],
