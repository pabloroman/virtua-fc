...
return [
    ...
    'stadium_stand_expansion_committed_message' => 'Se ha aprobado una ampliación de :capacity nuevos asientos permanentes. Estarán operativos en la temporada :completion.',
    'stadium_rebuild_committed_title' => 'Reforma del estadio aprobada',
    'stadium_rebuild_committed_message' => 'Se ha iniciado la reforma para un aforo de :capacity asientos. El nuevo estadio abrirá en la temporada :completion.',
    ...
    'stadium_uefa_upgrade_committed_message' => 'Se ha iniciado la reforma para alcanzar la Categoría UEFA :capacity. La nueva categoría estará vigente en la temporada :completion.',
