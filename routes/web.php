...
use App\Http\Actions\CallUpAcademyPlayer;
use App\Http\Actions\DismissAcademyPlayer;
use App\Http\Actions\LoanAcademyPlayer;
use App\Http\Actions\RecallAcademyPlayer;
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('game.owner')->group(function () {
        ...
        Route::post('/game/{gameId}/academy/{playerId}/callup', CallUpAcademyPlayer::class)->name('game.academy.callup');
        Route::post('/game/{gameId}/academy/{playerId}/recall', RecallAcademyPlayer::class)->name('game.academy.recall');
