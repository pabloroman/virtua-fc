            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-8">
                                        ...
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-sm text-slate-600">
                                                    {{ $loan->gamePlayer->position }} &middot; {{ $loan->gamePlayer->age }} years
                                                    &middot; From {{ $loan->parentTeam->name }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="text-right text-sm text-slate-600">
                                            Returns: <span class="font-medium">{{ $loan->return_at->format('M j, Y') }}</span>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
                    ...
                    <div class="mb-8">
                        ...
                        @if($loansOut->isEmpty())
                            <div class="text-center py-6 text-slate-500 border rounded-lg bg-slate-50 text-sm">
                                No players loaned out from your club.
                            </div>
                        @else
                            <div class="space-y-3">
