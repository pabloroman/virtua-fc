    ...
    <div class="min-h-screen py-8 md:py-16">
        <div class="max-w-2xl mx-auto px-4 sm:px-6">
            ...
            <div class="text-center mb-10">
                ...
                <h1 class="text-3xl md:text-4xl font-bold text-text-primary mb-2">{{ __('game.welcome_team') }}</h1>
                <p class="text-lg text-text-secondary">{{ __('game.welcome_appointed', ['team_de' => $game->team->nameWithDe()]) }}</p>
            </div>

            {{-- How it works --}}
            <div class="text-center mb-6">
                <h2 class="text-xl md:text-2xl font-bold text-text-primary">{{ __('game.welcome_how_it_works') }}</h2>
            </div>

            <div class="space-y-4 mb-10">
                {{-- Matchday --}}
                <div class="bg-surface-800/5 backdrop-blur-xs border border-border-strong rounded-xl p-5 flex items-start gap-4">
                    <div class="w-10 h-10 rounded-lg bg-accent-red/100/20 flex items-center justify-center shrink-0 mt-0.5">
                ...
                {{-- Squad --}}
                <div class="bg-surface-800/5 backdrop-blur-xs border border-border-strong rounded-xl p-5 flex items-start gap-4">
                    <div class="w-10 h-10 rounded-lg bg-accent-blue/100/20 flex items-center justify-center shrink-0 mt-0.5">
                ...
                {{-- Finances --}}
                <div class="bg-surface-800/5 backdrop-blur-xs border border-border-strong rounded-xl p-5 flex items-start gap-4">
                    <div class="w-10 h-10 rounded-lg bg-accent-gold/100/20 flex items-center justify-center shrink-0 mt-0.5">
