                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <button type="button"
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <h3 class="font-bold text-lg" :class="mode === 'career' ? 'text-red-900' : 'text-slate-300'">
                                            {{ __('game.mode_career') }}
                                        </h3>
                                        <p class="text-sm mt-0.5 truncate" :class="mode === 'career' ? 'text-accent-red' : 'text-slate-500'">
                                ...
                                <button type="button"
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <h3 class="font-bold text-lg" :class="mode === 'tournament' ? 'text-amber-900' : 'text-slate-300'">
                                            {{ __('game.mode_tournament') }}
                                        </h3>
                                        <p class="text-sm mt-0.5 truncate" :class="mode === 'tournament' ? 'text-accent-gold' : 'text-slate-500'">
                            ...
                            <div x-show="mode === 'tournament'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" class="space-y-6">
                                ...
                                <div class="relative">
                                    ...
                                    <div class="relative flex justify-center">
                                        <span class="bg-surface-800 px-3 text-xs text-slate-400 uppercase tracking-wide">{{ __('app.all_teams') }}</span>
                                    </div>
                                </div>
