    ...
    <main class="text-text-body pt-0 pb-32 sm:pt-2 sm:pb-32">
        <div class="max-w-4xl mx-auto px-4 pb-8"
             ...
             x-data="liveMatch({
                ...
                firstHalfStoppage: @js($firstHalfStoppage),
                secondHalfStoppage: @js($secondHalfStoppage),
                etFirstHalfStoppage: @js($etFirstHalfStoppage),
                etSecondHalfStoppage: @js($etSecondHalfStoppage),
                matchId: '{{ $match->id }}',
