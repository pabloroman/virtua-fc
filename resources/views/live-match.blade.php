    ...
    <main class="text-text-body pt-0 pb-32 sm:pt-2 sm:pb-32">
        <div class="max-w-4xl mx-auto px-4 pb-8"
             ...
             x-data="liveMatch({
                ...
                venueEnPhrase: {{ Js::from(\App\Modules\Stadium\Support\StadiumGrammar::withEn($match->venueName() ?? '')) }},
                venueElPhrase: {{ Js::from(\App\Modules\Stadium\Support\StadiumGrammar::withEl($match->venueName() ?? '')) }},
                venueDePhrase: {{ Js::from(\App\Modules\Stadium\Support\StadiumGrammar::withDe($match->venueName() ?? '')) }},
