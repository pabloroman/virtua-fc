...
<div x-data="{ mobileMenuOpen: false }">
    ...
    <nav class="hidden md:flex text-white/40 space-x-4 mt-4 items-center text-xl">
        ...
        <div><a class="hover:text-slate-300 @if(in_array(Route::currentRouteName(), ['game.transfers', 'game.scouting', 'game.scouting.hub'])) text-white @endif" href="{{ route('game.transfers', $game->id) }}">{{ __('app.transfers') }}</a></div>
        @endif
    ...
    <div x-show="mobileMenuOpen" x-cloak class="fixed inset-0 z-50 md:hidden">
        ...
        <div x-show="mobileMenuOpen"
            ...
            <nav class="py-2">
                ...
                <x-responsive-nav-link :href="route('game.transfers', $game->id)" :active="in_array(Route::currentRouteName(), ['game.transfers', 'game.scouting', 'game.scouting.hub'])">
                    {{ __('app.transfers') }}
                </x-responsive-nav-link>
                @endif
