...
<div class="p-5 md:p-8">
        ...
        <div class="flex items-start gap-4 min-w-0">
            ...
            <div class="min-w-0">
                <div class="flex items-center gap-2 mt-1.5">
                    ...
                    <span class="text-sm font-medium text-slate-400">{{ \App\Support\PositionMapper::toDisplayName($academyPlayer->position) }}</span>
                </div>
            ...
            <div class="space-y-3">
                @if($revealPhase >= 2)
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-sm font-semibold text-white">{{ $academyPlayer->potential_range }}</span>
                    </div>
                @else
                    <div class="flex items-center justify-between">
                        <span class="text-xs text-slate-400 uppercase tracking-wide">{{ __('game.potential') }}</span>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <span class="text-sm font-semibold text-white">{{ $academyPlayer->appeared_at->format('d M Y') }}</span>
                </div>
                <div class="flex items-center justify-between">
                    <span class="text-xs text-slate-400 uppercase tracking-wide">{{ __('squad.academy') }}</span>
                    <span class="text-sm font-semibold text-white">{{ trans_choice('squad.academy_seasons', $academyPlayer->seasons_in_academy, ['count' => $academyPlayer->seasons_in_academy]) }}</span>
                </div>
            </div>
        </div>
    </div>
    ...
    @unless($academyPlayer->is_on_loan)
        <div class="mt-6 pt-4 border-t border-white/10 flex flex-wrap gap-2">
