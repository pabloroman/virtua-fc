                ...
                <div class="p-4 sm:p-6 md:p-8">
                    ...
                    <div class="mt-6 space-y-6">
                            ...
                            <div class="border-l-4 border-l-red-500 pl-5">
                                <h4 class="font-semibold text-lg text-white mb-1">{{ __('transfers.counter_offers_received') }}</h4>
                            ...
                            <div class="border-l-4 border-l-amber-500 pl-5">
                                <h4 class="font-semibold text-lg text-white mb-1">{{ __('transfers.your_pending_bids') }}</h4>
                            ...
                            <div class="border-l-4 border-l-emerald-500 pl-5">
                                <h4 class="font-semibold text-lg text-white mb-1">{{ __('transfers.incoming_transfers') }}</h4>
