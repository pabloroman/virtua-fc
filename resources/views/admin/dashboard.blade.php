<x-admin-layout>
    ...
    <div class="mb-8">
        ...
        @else
            <div class="bg-surface-800 border border-border-default rounded-lg p-4 text-sm text-text-muted mb-4">
                {{ __('admin.no_data') }}
            </div>
        @endif
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <a href="{{ route('admin.users') }}" class="bg-surface-800 border border-border-default rounded-lg p-5 hover:border-accent-blue/40 transition-colors group">
        ...
        <a href="{{ route('admin.activation') }}" class="bg-surface-800 border border-border-default rounded-lg p-5 hover:border-accent-blue/40 transition-colors group">
            <div class="flex items-center gap-3 mb-2">
                <svg class="w-5 h-5 text-text-muted group-hover:text-accent-blue transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('admin.game-stats') }}" class="bg-surface-800 border border-border-default rounded-lg p-5 hover:border-accent-blue/40 transition-colors group">
            <div class="flex items-center gap-3 mb-2">
                <svg class="w-5 h-5 text-text-muted group-hover:text-accent-blue transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
