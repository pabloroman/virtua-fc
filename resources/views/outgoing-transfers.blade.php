                ...
                <div class="p-4 sm:p-6 md:p-8">
                    ...
                    <div x-data="{ helpOpen: false }">
                        ...
                        <div x-show="helpOpen" x-transition class="mt-3 bg-surface-700/50 border border-white/10 rounded-lg p-4 text-sm">
                            <p class="text-slate-400 mb-4">{{ __('transfers.transfers_help_intro') }}</p>
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                                {{-- Selling --}}
                                <div>
                                    <p class="font-semibold text-slate-300 mb-2">{{ __('transfers.transfers_help_selling_title') }}</p>
                                ...
                                {{-- Contracts --}}
                                <div>
                                    <p class="font-semibold text-slate-300 mb-2">{{ __('transfers.transfers_help_contracts_title') }}</p>
                                    <ul class="space-y-1 text-slate-400">
                                ...
                                {{-- Loans --}}
                                <div>
                                    <p class="font-semibold text-slate-300 mb-2">{{ __('transfers.transfers_help_loans_title') }}</p>
                                    <ul class="space-y-1 text-slate-400">
                    ...
                    <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                        ...
                        <div class="md:col-span-2 space-y-6">
                            ...
                            <div class="border-l-4 border-l-red-500 pl-5">
                                <h4 class="font-semibold text-lg text-white mb-1">{{ __('transfers.unsolicited_offers') }}</h4>
                            ...
                            <div class="border-l-4 border-l-red-500 pl-5">
                                <h4 class="font-semibold text-lg text-white mb-1">{{ __('transfers.pre_contract_offers_received') }}</h4>
                            ...
                            <div class="border-l-4 border-l-orange-500 pl-5">
                                <h4 class="font-semibold text-lg text-white mb-1">{{ __('transfers.renewal_counter_offers') }}</h4>
                                    ...
                                    <div x-data="{ showCounter: false }" class="bg-orange-50 rounded-lg p-4">
                                        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                                            <div class="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <div class="font-semibold text-white">{{ $player->player->name }}</div>
                                                    <div class="text-sm text-slate-400">
                            ...
                            <div class="border-l-4 border-l-sky-500 pl-5">
                                <h4 class="font-semibold text-lg text-white mb-1">{{ __('transfers.renewal_offers_sent') }}</h4>
                            ...
                            <div class="border-l-4 border-l-amber-500 pl-5">
                                <h4 class="font-semibold text-lg text-white mb-1">{{ __('transfers.offers_received') }}</h4>
                            ...
                            <div class="border-l-4 border-l-emerald-500 pl-5">
                                <h4 class="font-semibold text-lg text-white mb-1">{{ __('transfers.agreed_transfers') }}</h4>
                            ...
                            <div class="border-l-4 border-l-emerald-500 pl-5">
                                <h4 class="font-semibold text-lg text-white mb-1">{{ __('transfers.players_leaving_free') }}</h4>
                            ...
                            <div class="border-l-4 border-l-sky-500 pl-5">
                                <h4 class="font-semibold text-lg text-white mb-1">{{ __('transfers.loan_searches_section') }}</h4>
                                    ...
                                    <div class="bg-accent-blue/10 rounded-lg p-4">
                                        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                                            <div class="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <div class="font-semibold text-white">{{ $gamePlayer->name }}</div>
                                                    <div class="text-sm text-slate-400">
                            ...
                            <div class="border-l-4 border-l-amber-500 pl-5">
                                <h4 class="font-semibold text-lg text-white mb-1">{{ __('transfers.listed_players') }}</h4>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="border rounded-lg overflow-hidden">
                                ...
                                <div class="overflow-x-auto">
                                    <table class="w-full text-sm">
                                            ...
                                            <tr class="border-t border-white/5">
                                                ...
                                                <td class="py-2.5 pr-3">
                                                    <div class="flex items-center gap-1.5">
                                                        ...
                                                        <span class="font-medium text-white truncate">{{ $player->player->name }}</span>
                                                    </div>
                                                </td>
                                        ...
                                        @endphp
                                        <tr class="border-t border-white/5 {{ $hasPendingOffer ? 'bg-accent-red/10' : '' }}">
                                            <td class="py-2.5 pl-3 text-center">
                                                <x-position-badge :position="$player->position" size="sm" />
                                            </td>
                                            <td class="py-2.5 pr-3">
                            ...
                            <div class="border rounded-lg overflow-hidden">
                                <div class="px-5 py-3 bg-surface-700/50 border-b">
                                    <h4 class="font-semibold text-sm text-white">{{ __('transfers.pending_renewals_section') }}</h4>
                                </div>
                                <div class="divide-y divide-slate-100">
                                    ...
                                    <div class="px-4 py-3">
                                        <div class="flex items-center gap-2 mb-1">
                                            ...
                                            <span class="font-medium text-sm text-white truncate">{{ $player->player->name }}</span>
                                        </div>
                                ...
                                <div class="divide-y divide-slate-100">
                                    ...
                                    <div class="px-4 py-3">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="min-w-0">
                                                <div class="font-medium text-sm text-white truncate">{{ $loan->gamePlayer->name }}</div>
                                                <div class="text-xs text-slate-500">
