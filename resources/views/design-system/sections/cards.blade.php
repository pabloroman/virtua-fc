...
&lt;/div&gt;</code></pre>
    ...
    <div class="mb-12">
        ...
        <div class="bg-surface-700/30 border border-border-default rounded-lg p-6 mb-3">
            <div class="bg-surface-800 border border-border-default rounded-lg overflow-hidden divide-y divide-white/5">
        ...
        <div x-data="{ copied: false }" class="relative">
            ...
            <pre class="bg-surface-700 text-text-body rounded-lg p-4 overflow-x-auto text-xs leading-relaxed"><code x-ref="statRowCode">&lt;div class="bg-surface-800 border border-border-default rounded-lg overflow-hidden divide-y divide-white/5"&gt;
    &lt;div class="px-4 py-3 flex items-center justify-between"&gt;
...
&lt;/div&gt;</code></pre>
    ...
    <div class="mb-12">
        ...
        <div class="bg-surface-700/30 border border-border-default rounded-lg p-6 space-y-4 mb-3">
            <div class="border-l-4 border-l-accent-gold bg-surface-800 border border-border-default rounded-r-lg pl-5 pr-4 py-3">
            ...
            <div class="border-l-4 border-l-accent-green bg-surface-800 border border-border-default rounded-r-lg pl-5 pr-4 py-3">
            ...
            <div class="border-l-4 border-l-accent-blue bg-surface-800 border border-border-default rounded-r-lg pl-5 pr-4 py-3">
        ...
        <div x-data="{ copied: false }" class="relative">
            ...
            <pre class="bg-surface-700 text-text-body rounded-lg p-4 overflow-x-auto text-xs leading-relaxed"><code x-ref="accentCode">&lt;div class="border-l-4 border-l-accent-gold bg-surface-800 border border-border-default rounded-r-lg pl-5 pr-4 py-3"&gt;
...
&lt;/div&gt;</code></pre>
    ...
    <div class="mb-12">
        ...
        <div class="bg-surface-700/30 border border-border-default rounded-lg p-6 mb-3">
            <div class="rounded-lg overflow-hidden border border-border-default max-w-sm">
        ...
        <div x-data="{ copied: false }" class="relative">
            ...
            <pre class="bg-surface-700 text-text-body rounded-lg p-4 overflow-x-auto text-xs leading-relaxed"><code x-ref="gradientCode">&lt;div class="rounded-lg overflow-hidden border border-border-default"&gt;
    &lt;div class="bg-linear-to-br from-surface-700 to-surface-800 px-4 py-5"&gt;
...
&lt;/div&gt;</code></pre>
    ...
    <div>
        ...
        <div class="bg-surface-700/30 border border-border-default rounded-lg p-6 mb-3">
            <div class="tip-card bg-accent-blue/8 border border-accent-blue/15 rounded-lg px-4 py-3.5">
        ...
        <div x-data="{ copied: false }" class="relative">
            ...
            <pre class="bg-surface-700 text-text-body rounded-lg p-4 overflow-x-auto text-xs leading-relaxed"><code x-ref="tipCode">&lt;div class="tip-card bg-accent-blue/8 border border-accent-blue/15 rounded-lg px-4 py-3.5"&gt;
    &lt;div class="flex items-start gap-3"&gt;
