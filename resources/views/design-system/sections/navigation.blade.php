<section id="navigation" class="mb-20">
    ...
    <div class="mb-12">
        ...
        <div class="bg-surface-700/30 border border-white/5 rounded-xl p-6 mb-3">
            <div class="bg-surface-900/95 backdrop-blur-md border-b border-white/5 rounded-lg px-4 py-3">
                <nav class="flex items-center gap-1">
                    <a href="#" class="nav-item active px-3 py-2 text-xs font-medium uppercase tracking-wider text-white">Dashboard</a>
                    <a href="#" class="nav-item px-3 py-2 text-xs font-medium uppercase tracking-wider text-slate-500 hover:text-slate-300">Squad</a>
                    <a href="#" class="nav-item px-3 py-2 text-xs font-medium uppercase tracking-wider text-slate-500 hover:text-slate-300">Starting XI</a>
                    <a href="#" class="nav-item px-3 py-2 text-xs font-medium uppercase tracking-wider text-slate-500 hover:text-slate-300">Finances</a>
                    <a href="#" class="nav-item px-3 py-2 text-xs font-medium uppercase tracking-wider text-slate-500 hover:text-slate-300">Transfers</a>
                    <a href="#" class="nav-item px-3 py-2 text-xs font-medium uppercase tracking-wider text-slate-500 hover:text-slate-300">Calendar</a>
                </nav>
            </div>
        </div>
        ...
        <div x-data="{ copied: false }" class="relative">
            ...
            <pre class="bg-surface-700 text-slate-300 rounded-lg p-4 overflow-x-auto text-xs leading-relaxed"><code x-ref="code">&lt;nav class="flex items-center gap-1"&gt;
    &lt;a href="#" class="nav-item active px-3 py-2 text-xs font-medium uppercase tracking-wider text-white"&gt;
        Dashboard
    &lt;/a&gt;
    &lt;a href="#" class="nav-item px-3 py-2 text-xs font-medium uppercase tracking-wider text-slate-500 hover:text-slate-300"&gt;
        Squad
    &lt;/a&gt;
&lt;/nav&gt;
...
&lt;!-- The .nav-item.active class adds a blue underline via CSS ::after pseudo-element --&gt;</code></pre>
    ...
    <div class="mb-12">
        ...
        <div x-data="{ copied: false }" class="relative mb-4">
            ...
            <pre class="bg-surface-700 text-slate-300 rounded-lg p-4 overflow-x-auto text-xs leading-relaxed"><code x-ref="code">&lt;x-section-nav :items="[
    ...
    <div class="mb-12">
        ...
        <div class="bg-surface-700/30 border border-white/5 rounded-xl p-6 mb-3">
            ...
            <div class="max-w-sm">
                <div class="bg-surface-900/95 backdrop-blur-md border border-white/5 rounded-lg px-4 py-3 flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        {{-- Hamburger icon --}}
                        <button class="text-slate-400 hover:text-white min-h-[44px] min-w-[44px] flex items-center justify-center">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5"/>
                            </svg>
                        </button>
                        <div>
                            <span class="font-heading font-semibold text-sm text-white uppercase tracking-wide">Real Madrid</span>
                            <p class="text-[10px] text-slate-500 uppercase tracking-widest">Season 2025/26</p>
                        </div>
                    </div>
            ...
            <div class="max-w-[288px] mt-4">
                <div class="bg-surface-800 border border-white/5 rounded-lg shadow-xl overflow-hidden">
                    <div class="flex items-center justify-between p-4 border-b border-white/10">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 bg-surface-600 rounded-lg shrink-0"></div>
                            <div>
                                <h3 class="font-heading font-semibold text-sm text-white uppercase tracking-wide">Real Madrid</h3>
                                <p class="text-[10px] text-slate-500 uppercase tracking-widest">Season 2025/26</p>
                            </div>
                        </div>
                    ...
                    <nav class="py-2">
                        <a href="#" class="block w-full ps-3 pe-4 py-2 border-l-4 border-accent-blue text-start text-base font-medium text-white bg-accent-blue/10">Dashboard</a>
                        <a href="#" class="block w-full ps-3 pe-4 py-2 border-l-4 border-transparent text-start text-base font-medium text-slate-400 hover:text-white hover:bg-surface-700">Squad</a>
                        <a href="#" class="block w-full ps-3 pe-4 py-2 border-l-4 border-transparent text-start text-base font-medium text-slate-400 hover:text-white hover:bg-surface-700">Starting XI</a>
                        <a href="#" class="block w-full ps-3 pe-4 py-2 border-l-4 border-transparent text-start text-base font-medium text-slate-400 hover:text-white hover:bg-surface-700">Finances</a>
                        <a href="#" class="block w-full ps-3 pe-4 py-2 border-l-4 border-transparent text-start text-base font-medium text-slate-400 hover:text-white hover:bg-surface-700">Transfers</a>
                    </nav>
                </div>
            </div>
        </div>
        ...
        <div x-data="{ copied: false }" class="relative">
            ...
            <pre class="bg-surface-700 text-slate-300 rounded-lg p-4 overflow-x-auto text-xs leading-relaxed"><code x-ref="code">&lt;!-- Hamburger button (visible on mobile only) --&gt;
&lt;button @click="mobileMenuOpen = true" class="lg:hidden text-slate-400 hover:text-white min-h-[44px] min-w-[44px]"&gt;
    &lt;!-- hamburger SVG --&gt;
&lt;/button&gt;

&lt;!-- Drawer uses x-show="mobileMenuOpen" with translate-x transitions --&gt;
&lt;!-- Panel: bg-surface-800 border-r border-white/5 w-72 --&gt;
    ...
    <div class="mb-12">
        ...
        <div class="bg-surface-700/30 border border-white/5 rounded-xl p-6 mb-3">
            <x-dropdown align="left" width="48">
                <x-slot name="trigger">
                    <button class="inline-flex items-center gap-1.5 px-3 py-2 bg-surface-700 border border-white/10 rounded-lg text-sm text-slate-300 hover:text-white hover:bg-surface-600 transition-colors">
                        Options
        ...
        <div x-data="{ copied: false }" class="relative">
            ...
            <pre class="bg-surface-700 text-slate-300 rounded-lg p-4 overflow-x-auto text-xs leading-relaxed"><code x-ref="code">&lt;x-dropdown align="left" width="48"&gt;
    &lt;x-slot name="trigger"&gt;
        &lt;button class="inline-flex items-center gap-1.5 px-3 py-2 bg-surface-700 border border-white/10 rounded-lg text-sm text-slate-300"&gt;
            Options
            &lt;!-- chevron SVG --&gt;
        &lt;/button&gt;
    &lt;/x-slot&gt;
...
&lt;/x-dropdown&gt;</code></pre>
    ...
    <div class="mb-12">
        ...
        <div class="bg-surface-700/30 border border-white/5 rounded-xl p-6 mb-3">
            ...
            <div class="flex items-center justify-between bg-surface-800 rounded-lg px-4 py-3 max-w-md">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <span class="text-sm font-medium text-white">Jude Bellingham</span>
                        <p class="text-[10px] text-slate-500">MC &middot; 22 years</p>
                    </div>
                </div>
                <div x-data="{ open: false }" @click.outside="open = false" class="relative">
                    <button @click="open = !open" class="p-2 text-slate-400 hover:text-white rounded-lg hover:bg-surface-600 transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center">
                    ...
                    <div x-show="open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100"
                         class="absolute right-0 mt-2 w-48 bg-surface-700 border border-white/5 rounded-lg shadow-xl z-50 py-1" style="display: none;">
        ...
        <div x-data="{ copied: false }" class="relative">
            ...
            <pre class="bg-surface-700 text-slate-300 rounded-lg p-4 overflow-x-auto text-xs leading-relaxed"><code x-ref="code">&lt;div x-data="{ open: false }" @click.outside="open = false" class="relative"&gt;
    &lt;button @click="open = !open" class="p-2 text-slate-400 hover:text-white rounded-lg hover:bg-surface-600 min-h-[44px] min-w-[44px]"&gt;
        &lt;!-- three-dot SVG --&gt;
    &lt;/button&gt;
    &lt;div x-show="open" x-transition
         class="absolute right-0 mt-2 w-48 bg-surface-700 border border-white/5 rounded-lg shadow-xl z-50 py-1"&gt;
    ...
    <div class="mb-12">
        ...
        <div class="bg-surface-700/30 border border-white/5 rounded-xl p-6 mb-3">
            <div x-data="{ active: 'all' }" class="flex flex-wrap gap-2">
                <button @click="active = 'all'" :class="active === 'all' ? 'bg-accent-blue text-white' : 'bg-surface-700 text-slate-400 hover:text-slate-200'" class="px-3 py-1.5 rounded-lg text-xs font-medium transition-colors">All</button>
                <button @click="active = 'gk'" :class="active === 'gk' ? 'bg-accent-blue text-white' : 'bg-surface-700 text-slate-400 hover:text-slate-200'" class="px-3 py-1.5 rounded-lg text-xs font-medium transition-colors">GK</button>
                <button @click="active = 'def'" :class="active === 'def' ? 'bg-accent-blue text-white' : 'bg-surface-700 text-slate-400 hover:text-slate-200'" class="px-3 py-1.5 rounded-lg text-xs font-medium transition-colors">DEF</button>
                <button @click="active = 'mid'" :class="active === 'mid' ? 'bg-accent-blue text-white' : 'bg-surface-700 text-slate-400 hover:text-slate-200'" class="px-3 py-1.5 rounded-lg text-xs font-medium transition-colors">MID</button>
                <button @click="active = 'fwd'" :class="active === 'fwd' ? 'bg-accent-blue text-white' : 'bg-surface-700 text-slate-400 hover:text-slate-200'" class="px-3 py-1.5 rounded-lg text-xs font-medium transition-colors">FWD</button>
            </div>
        </div>
        ...
        <div x-data="{ copied: false }" class="relative">
            ...
            <pre class="bg-surface-700 text-slate-300 rounded-lg p-4 overflow-x-auto text-xs leading-relaxed"><code x-ref="code">&lt;div x-data="{ active: 'all' }" class="flex flex-wrap gap-2"&gt;
    &lt;button @click="active = 'all'"
            :class="active === 'all' ? 'bg-accent-blue text-white' : 'bg-surface-700 text-slate-400 hover:text-slate-200'"
            class="px-3 py-1.5 rounded-lg text-xs font-medium transition-colors"&gt;
        All
    &lt;/button&gt;
    &lt;button @click="active = 'gk'"
            :class="active === 'gk' ? 'bg-accent-blue text-white' : 'bg-surface-700 text-slate-400 hover:text-slate-200'"
            class="px-3 py-1.5 rounded-lg text-xs font-medium transition-colors"&gt;
        GK
    &lt;/button&gt;
    &lt;!-- ... more positions --&gt;
&lt;/div&gt;</code></pre>
    ...
    <div>
        ...
        <div class="bg-surface-700/30 border border-white/5 rounded-xl p-6 mb-3">
            <div class="bg-surface-900/95 backdrop-blur-md border-b border-white/5 rounded-lg px-4 py-3">
                <nav class="flex items-center gap-1">
                    <a href="#" class="nav-item px-3 py-2 text-xs font-medium uppercase tracking-wider text-slate-500 hover:text-slate-300">Dashboard</a>
                    <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                        <button @click="open = !open" class="nav-item active px-3 py-2 text-xs font-medium uppercase tracking-wider flex items-center gap-1 text-white">
                            Competitions
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100"
                             class="absolute left-0 z-50 mt-2 w-48 rounded-lg shadow-xl bg-surface-800 border border-white/10" style="display: none;">
                            <div class="py-1">
                                <a href="#" class="block px-4 py-2 text-sm text-white bg-surface-700 font-semibold">La Liga</a>
                                <a href="#" class="block px-4 py-2 text-sm text-slate-300 hover:bg-surface-700 hover:text-white">Copa del Rey</a>
                                <a href="#" class="block px-4 py-2 text-sm text-slate-300 hover:bg-surface-700 hover:text-white">Champions League</a>
                            </div>
                        </div>
                    </div>
                    <a href="#" class="nav-item px-3 py-2 text-xs font-medium uppercase tracking-wider text-slate-500 hover:text-slate-300">Calendar</a>
        ...
        <div x-data="{ copied: false }" class="relative">
            ...
            <pre class="bg-surface-700 text-slate-300 rounded-lg p-4 overflow-x-auto text-xs leading-relaxed"><code x-ref="code">&lt;div class="relative" x-data="{ open: false }" @click.outside="open = false"&gt;
    ...
    &lt;/button&gt;
    &lt;div x-show="open" x-transition
         class="absolute left-0 z-50 mt-2 w-48 rounded-lg shadow-xl bg-surface-800 border border-white/10"&gt;
        &lt;div class="py-1"&gt;
            &lt;a href="#" class="block px-4 py-2 text-sm text-slate-300 hover:bg-surface-700 hover:text-white"&gt;
                La Liga
            &lt;/a&gt;
        &lt;/div&gt;
    &lt;/div&gt;
