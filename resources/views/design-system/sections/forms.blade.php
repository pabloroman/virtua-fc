<section id="forms" class="mb-20">
    ...
    <div class="mb-12">
        ...
        <div x-data="{ copied: false }" class="relative">
            ...
            <pre class="bg-surface-700 text-slate-300 rounded-lg p-4 overflow-x-auto text-xs leading-relaxed"><code x-ref="code">&lt;x-input-label for="name" value="Player Name" /&gt;
...
&lt;x-input-error :messages="$errors-&gt;get('name')" class="mt-2" /&gt;</code></pre>
    ...
    {{-- Select Input --}}
    <div class="mb-12">
        <h3 class="text-lg font-semibold text-white mb-2">Select Input</h3>
        <p class="text-sm text-slate-400 mb-4">Same dark styling as text inputs. Options inherit the dark background. Supports disabled state.</p>
        ...
        <div x-data="{ copied: false }" class="relative">
            ...
            <pre class="bg-surface-700 text-slate-300 rounded-lg p-4 overflow-x-auto text-xs leading-relaxed"><code x-ref="code">&lt;x-input-label for="formation" value="Formation" /&gt;
...
&lt;/x-select-input&gt;</code></pre>
    ...
    <div class="mb-12">
        ...
        <div class="bg-surface-700/30 border border-white/5 rounded-xl p-6 mb-3">
            <div class="space-y-3">
                <label class="flex items-center gap-2 cursor-pointer">
                    ...
                    <span class="text-sm text-slate-300">Auto-select best lineup</span>
                </label>
                <label class="flex items-center gap-2 cursor-pointer">
                    <x-checkbox-input name="demo-check-2" />
                    <span class="text-sm text-slate-300">Include youth players</span>
                </label>
                <label class="flex items-center gap-2 cursor-pointer opacity-50">
                    <x-checkbox-input name="demo-check-3" disabled />
                    <span class="text-sm text-slate-300">Disabled checkbox</span>
                </label>
            </div>
        </div>
        ...
        <div x-data="{ copied: false }" class="relative">
            ...
            <pre class="bg-surface-700 text-slate-300 rounded-lg p-4 overflow-x-auto text-xs leading-relaxed"><code x-ref="code">&lt;label class="flex items-center gap-2 cursor-pointer"&gt;
...
&lt;/label&gt;</code></pre>
    ...
    <div class="mb-12">
        ...
        <div x-data="{ copied: false }" class="relative">
            ...
            <pre class="bg-surface-700 text-slate-300 rounded-lg p-4 overflow-x-auto text-xs leading-relaxed"><code x-ref="code">&lt;x-money-input name="transfer_budget" :value="5000000" :min="100000" /&gt;
&lt;x-money-input name="bid_amount" :value="500000" :min="10000" size="sm" /&gt;</code></pre>
    ...
    <div class="mb-12">
        ...
        <div x-data="{ copied: false }" class="relative">
            ...
            <pre class="bg-surface-700 text-slate-300 rounded-lg p-4 overflow-x-auto text-xs leading-relaxed"><code x-ref="code">&lt;x-text-input class="border-accent-red/50 focus:border-accent-red focus:ring-accent-red" /&gt;
&lt;x-input-error :messages="$errors-&gt;get('email')" class="mt-2" /&gt;</code></pre>
    ...
    <div class="mb-12">
        <h3 class="text-lg font-semibold text-white mb-2">Search Input</h3>
        <p class="text-sm text-slate-400 mb-4">Compact search field with an icon prefix. Used in table toolbars and filter bars. Not a Blade component -- built inline with utility classes.</p>
        ...
        <div x-data="{ copied: false }" class="relative">
            ...
            <pre class="bg-surface-700 text-slate-300 rounded-lg p-4 overflow-x-auto text-xs leading-relaxed"><code x-ref="code">&lt;div class="relative"&gt;
    &lt;svg class="absolute left-2.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-slate-500 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24"&gt;
        &lt;path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /&gt;
    &lt;/svg&gt;
...
&lt;/div&gt;</code></pre>
    ...
    {{-- Complete Form Group --}}
    <div>
        <h3 class="text-lg font-semibold text-white mb-2">Complete Form Group</h3>
        <p class="text-sm text-slate-400 mb-4">Standard form pattern composing label, input, select, checkbox, and error components together on a dark surface.</p>
            ...
            <div class="max-w-md space-y-4">
                ...
                <div>
                    <label class="flex items-center gap-2 cursor-pointer">
                        ...
                        <span class="text-sm text-slate-300">I accept the terms</span>
                    </label>
                </div>
                <div>
        ...
        <div x-data="{ copied: false }" class="relative">
            ...
            <pre class="bg-surface-700 text-slate-300 rounded-lg p-4 overflow-x-auto text-xs leading-relaxed"><code x-ref="code">&lt;div class="space-y-4"&gt;
    &lt;div&gt;
