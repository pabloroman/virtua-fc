<section id="overview" class="mb-20">
    ...
    <div class="mb-12">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
            @foreach([
                ['name' => 'Laravel 13', 'desc' => 'Backend framework', 'icon' => '<svg class="w-6 h-6" viewBox="0 0 24 24" fill="none"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>'],
