<section id="typography" class="mb-20">
    ...
    {{-- HEADINGS --}}
    {{-- ================================================================== --}}
    <h3 class="text-lg font-semibold text-white mb-4">Headings</h3>

    <div class="bg-surface-700/30 border border-white/5 rounded-xl p-6 space-y-6 mb-4">
        {{-- Page title --}}
        <div>
    ...
    <div x-data="{ copied: false }" class="relative mb-12">
        ...
        <pre class="bg-surface-700 text-slate-300 rounded-lg p-4 overflow-x-auto text-xs leading-relaxed"><code x-ref="code">&lt;h1 class="font-heading text-2xl lg:text-3xl font-bold uppercase tracking-wide text-white"&gt;Page Title&lt;/h1&gt;
&lt;span class="font-heading font-semibold text-base leading-none tracking-wide text-white"&gt;Team Name&lt;/span&gt;
&lt;h2 class="text-lg font-semibold text-white"&gt;Section Heading&lt;/h2&gt;</code></pre>
    </div>
    ...
    <div x-data="{ copied: false }" class="relative mb-12">
        ...
        <pre class="bg-surface-700 text-slate-300 rounded-lg p-4 overflow-x-auto text-xs leading-relaxed"><code x-ref="code">&lt;span class="text-[10px] text-slate-500 uppercase tracking-widest"&gt;La Liga &middot; Season 2025/26&lt;/span&gt;
&lt;span class="font-heading text-[11px] font-semibold uppercase tracking-widest text-slate-500"&gt;Goalkeepers&lt;/span&gt;
&lt;span class="text-xs font-medium uppercase tracking-wider text-slate-400"&gt;Nav Item&lt;/span&gt;
&lt;span class="text-[10px] text-slate-500"&gt;Stat Label&lt;/span&gt;</code></pre>
    </div>

    {{-- ================================================================== --}}
    {{-- BODY TEXT --}}
    {{-- ================================================================== --}}
    <h3 class="text-lg font-semibold text-white mb-4">Body Text</h3>

    <div class="bg-surface-700/30 border border-white/5 rounded-xl p-6 space-y-5 mb-4">
        {{-- Player name --}}
        <div>
    ...
    <div x-data="{ copied: false }" class="relative mb-12">
        ...
        <pre class="bg-surface-700 text-slate-300 rounded-lg p-4 overflow-x-auto text-xs leading-relaxed"><code x-ref="code">&lt;span class="text-sm font-medium text-white"&gt;Player Name&lt;/span&gt;
&lt;p class="text-sm text-slate-400"&gt;Body text&lt;/p&gt;
&lt;span class="text-xs text-slate-500"&gt;Secondary text&lt;/span&gt;
&lt;a href="#" class="text-sm text-accent-blue hover:text-blue-400"&gt;Link&lt;/a&gt;</code></pre>
    ...
    {{-- NUMBERS & VALUES --}}
    {{-- ================================================================== --}}
    <h3 class="text-lg font-semibold text-white mb-4">Numbers &amp; Values</h3>
    ...
    <div x-data="{ copied: false }" class="relative mb-12">
        ...
        <pre class="bg-surface-700 text-slate-300 rounded-lg p-4 overflow-x-auto text-xs leading-relaxed"><code x-ref="code">{{-- Rating badge --}}
&lt;span class="font-heading font-bold text-base text-accent-blue"&gt;78&lt;/span&gt;
...
{{-- Match score --}}
&lt;span class="font-heading text-3xl md:text-5xl font-bold text-white"&gt;2 - 1&lt;/span&gt;</code></pre>
    </div>

    {{-- ================================================================== --}}
    {{-- FONT SIZE SCALE --}}
    {{-- ================================================================== --}}
    <h3 class="text-lg font-semibold text-white mb-4">Font Size Scale</h3>

    <div class="bg-surface-700/30 border border-white/5 rounded-xl overflow-hidden mb-12">
        @foreach([
        ...
        <div class="px-5 py-3 flex items-baseline gap-4 {{ !$loop->last ? 'border-b border-white/5' : '' }}">
            <div class="w-28 shrink-0">
                <code class="text-[10px] text-accent-blue">{{ $size['name'] }}</code>
                <div class="text-[10px] text-slate-600">{{ $size['size'] }}</div>
            </div>
            <div class="{{ $size['class'] }} text-white truncate flex-1">The quick brown fox</div>
            <div class="text-xs text-slate-500 hidden md:block shrink-0">{{ $size['usage'] }}</div>
        </div>
        @endforeach
    </div>
