<section id="buttons" class="mb-20">
    ...
    <p class="text-sm text-text-secondary mb-10">All buttons use Blade components with a minimum height of 44px for touch accessibility, <code class="text-[10px] bg-surface-700 px-1.5 py-0.5 rounded-sm text-text-body">rounded-lg</code> corners, and smooth transitions. Focus rings use <code class="text-[10px] bg-surface-700 px-1.5 py-0.5 rounded-sm text-text-body">focus:ring-offset-surface-900</code> to match the dark background.</p>
    ...
    <div class="mb-12">
        ...
        <p class="text-sm text-text-secondary mb-4">The main call-to-action. Defaults to accent-blue. Four color variants available for semantic differentiation.</p>
...
&lt;x-primary-button color="amber"&gt;Warning&lt;/x-primary-button&gt;</code></pre>
    ...
    <div class="mb-12">
        ...
        <p class="text-sm text-text-secondary mb-4">Used for secondary actions. Surface background with a subtle white/10 border. Text lightens on hover.</p>
...
&lt;x-ghost-button disabled&gt;Disabled&lt;/x-ghost-button&gt;</code></pre>
    ...
    <div class="mb-12">
        ...
        <p class="text-sm text-text-secondary mb-4">Components support a <code class="text-[10px] bg-surface-700 px-1.5 py-0.5 rounded-sm text-text-body">size</code> prop with <code class="text-[10px] bg-surface-700 px-1.5 py-0.5 rounded-sm text-text-body">xs</code> and <code class="text-[10px] bg-surface-700 px-1.5 py-0.5 rounded-sm text-text-body">default</code>. For larger or full-width buttons, override with Tailwind classes.</p>
