...
export default function liveMatch(config) {
    ...
    const component = {
         ...
         * Used on the half-time substitution screen where the final
         * event-weighted rating hasn't stabilized yet. Returns null when no
         * performance data is available for the player.
         */
