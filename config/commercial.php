...
return [
    ...
    'naming_rights' => [
        ...
        'sponsors' => [
            ...
            // ── Portugal (PT) — national & regional ──────────────────────
            ['name' => 'Galp',             'reach' => 'national', 'country' => 'PT', 'stadium' => 'Estádio Galp'],
            ['name' => 'MEO',              'reach' => 'national', 'country' => 'PT', 'stadium' => 'Estádio MEO'],
            ['name' => 'NOS',              'reach' => 'national', 'country' => 'PT', 'stadium' => 'Estádio NOS'],
            ['name' => 'Millennium bcp',   'reach' => 'national', 'country' => 'PT', 'stadium' => 'Estádio Millennium'],
            ['name' => 'Caixa Geral',      'reach' => 'national', 'country' => 'PT', 'stadium' => 'Estádio Caixa'],
            ['name' => 'Pingo Doce',       'reach' => 'national', 'country' => 'PT', 'stadium' => 'Estádio Pingo Doce'],
            ['name' => 'Continente',       'reach' => 'national', 'country' => 'PT', 'stadium' => 'Estádio Continente'],
            ['name' => 'TAP',              'reach' => 'national', 'country' => 'PT', 'stadium' => 'Estádio TAP'],
            ['name' => 'Super Bock',       'reach' => 'regional', 'country' => 'PT', 'stadium' => 'Estádio Super Bock'],
            ['name' => 'Sagres',           'reach' => 'regional', 'country' => 'PT', 'stadium' => 'Estádio Sagres'],
            ['name' => 'Delta Cafés',      'reach' => 'regional', 'country' => 'PT', 'stadium' => 'Estádio Delta'],
            ['name' => 'Água do Luso',     'reach' => 'regional', 'country' => 'PT', 'stadium' => 'Estádio Luso'],

            // ── Netherlands (NL) — national & regional ───────────────────
            ['name' => 'Rabobank',         'reach' => 'national', 'country' => 'NL', 'stadium' => 'Rabobank Stadion'],
            ['name' => 'ING',              'reach' => 'national', 'country' => 'NL', 'stadium' => 'ING Arena'],
            ['name' => 'KPN',              'reach' => 'national', 'country' => 'NL', 'stadium' => 'KPN Arena'],
            ['name' => 'Albert Heijn',     'reach' => 'national', 'country' => 'NL', 'stadium' => 'Albert Heijn Stadion'],
            ['name' => 'Jumbo',            'reach' => 'national', 'country' => 'NL', 'stadium' => 'Jumbo Stadion'],
            ['name' => 'Heineken',         'reach' => 'national', 'country' => 'NL', 'stadium' => 'Heineken Arena'],
            ['name' => 'KLM',              'reach' => 'national', 'country' => 'NL', 'stadium' => 'KLM Arena'],
            ['name' => 'Achmea',           'reach' => 'national', 'country' => 'NL', 'stadium' => 'Achmea Stadion'],
            ['name' => 'Grolsch',          'reach' => 'regional', 'country' => 'NL', 'stadium' => 'Grolsch Veste'],
            ['name' => 'Bavaria',          'reach' => 'regional', 'country' => 'NL', 'stadium' => 'Bavaria Stadion'],
            ['name' => 'Hertog Jan',       'reach' => 'regional', 'country' => 'NL', 'stadium' => 'Hertog Jan Stadion'],
            ['name' => 'Douwe Egberts',    'reach' => 'regional', 'country' => 'NL', 'stadium' => 'Douwe Egberts Stadion'],
        ],
    ],
